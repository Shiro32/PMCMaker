...
//        }
    ...
    return diagData(
        R.color.tsbTitleColor, R.string.diag_1_title_label, R.string.diag_1_subtitle_label, R.string.diag_1_description, R.string.diag_1_unit,
        icon, revTSBs[0].toInt().toString(), judge)
}


fun drawDIAG2() : diagData {
    ...
    return diagData(
        R.color.tsbTitleColor, R.string.diag_2_title_label, R.string.diag_2_subtitle_label, R.string.diag_2_description, R.string.diag_2_unit,
        icon, count.toString(), judge)
}

fun drawDIAG3() : diagData {
    // +5くらいのTSBがレースに最適
    ...
    return diagData(
        R.color.tsbTitleColor, R.string.diag_3_title_label, R.string.diag_3_subtitle_label, R.string.diag_3_description, R.string.diag_3_unit,
        icon, tsb.toString(), msg)
}

fun drawDIAG4() : diagData {
    // CTL=50を目標にするとよいようです。
    var icon = R.drawable.growth
    ...
    return diagData(
        R.color.ctlTitleColor, R.string.diag_4_title_label, R.string.diag_4_subtitle_label, R.string.diag_4_description, R.string.diag_4_unit,
        icon, revCTLs[0].toInt().toString(), msg)
}

fun drawDIAG5() : diagData {
    // １週間で５程度、CTLが上昇するとよい
    var icon = R.drawable.growth
    ...
    return diagData(
        R.color.ctlTitleColor, R.string.diag_5_title_label, R.string.diag_5_subtitle_label, R.string.diag_5_description, R.string.diag_5_unit,
        icon, growth.toString(), msg)
}

fun drawDIAG6() : diagData {
    ...
    return diagData(
        R.color.ctlTitleColor, R.string.diag_6_title_label, R.string.diag_6_subtitle_label, R.string.diag_6_description, R.string.diag_6_unit,
        icon, count.toString(), msg)
}

fun drawDIAG7() : diagData {
    // 2週連続でCTLが減少するとサボりすぎ
    ...
    return diagData(
        R.color.ctlTitleColor, R.string.diag_7_title_label, R.string.diag_7_subtitle_label, R.string.diag_7_description, R.string.diag_7_unit,
        icon, count.toString(), msg)
}

fun drawDIAG8() : diagData {
    ...
    return diagData(
        R.color.atlTitleColor, R.string.diag_8_title_label, R.string.diag_8_subtitle_label, R.string.diag_8_description, R.string.diag_8_unit,
